...
class TextValueTile extends StatelessWidget {
  TextValueTile({
    Key? key,
    required this.width,
  ...
  TextValueTile add(IUpdate updater) {
              ...
              children: <Widget>[
                Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: height.toDouble() / 3,
                      // set font size to 20
                      color: extractValueColor(state.data()), // set text color to blue
                    ),
